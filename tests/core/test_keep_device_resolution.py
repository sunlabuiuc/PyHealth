...
class TestExplicitDevicesPassThrough(unittest.TestCase):
...
class TestRealTorchIntegration(unittest.TestCase):
    ...
    def test_auto_returns_valid_device_string(self):
        ...
        self.assertIn(resolved, ("cuda", "mps", "cpu"))
    ...
    def test_auto_returns_device_torch_accepts(self):
        ...
        self.assertEqual(str(t.device).split(":")[0], resolved)
