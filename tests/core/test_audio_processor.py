...
class TestAudioProcessor(unittest.TestCase):
    ...
    def test_init_default(self):
        ...
        self.assertIsNone(processor.duration)
    ...
    def test_init_custom(self):
        ...
        self.assertEqual(processor.sample_rate, 8000)
    ...
    def test_process_stereo_to_mono(self):
        processor = AudioProcessor(to_mono=True)
    ...
    def test_process_stereo_keep_stereo(self):
        processor = AudioProcessor(to_mono=False)
        result = processor.process(self.stereo_path)
    ...
    def test_process_duration_truncate(self):
        ...
        # Should be truncated
        self.assertEqual(result.shape[1], 8000)  # 0.5 * 16000
    ...
    def test_process_duration_pad(self):
        ...
        # Should be padded
        self.assertEqual(result.shape[1], 32000)  # 2.0 * 16000
    ...
    def test_repr(self):
        ...
        self.assertIn('sample_rate=16000', repr_str)
