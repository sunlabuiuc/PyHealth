...
class TestShapExplainerMLP(unittest.TestCase):
    ...
    def test_basic_attribution(self):
        ...
        #print("Data batch keys:", data_batch.keys())
        #print("data_batch shapes:", {k: v.shape for k, v in data_batch.items()})
        ...
        for method in ['kernel']:
            explainer = ShapExplainer(
                self.model, 
                method=method,
                use_embeddings=True,     # Don't use embeddings for tensor features
