...
class TestInnerMap(unittest.TestCase):
    ...
    def test_lookup(self):
        ...
        logging.info("Done testing lookup function ...")

    def test_get_ancestors(self):
        self.assertEqual(
            self.inner_map.get_ancestors("428.0"),
            ['428', '420-429.99', '390-459.99', '001-999.9'],
            msg="get_ancestors function of InnerMap failed"
            )
        logging.info("Done testing get_ancestors function ...")
    ...
    def test_get_descendants(self):
        ...
        logging.info("Done testing get_descendants function ...")
