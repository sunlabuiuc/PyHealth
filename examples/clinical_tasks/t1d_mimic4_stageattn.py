...
if __name__ == "__main__":
    ...
    # STEP 2: Apply StageNet DKA prediction task with padding
    #
    ...
    processor_dir = "/home/yongdaf2/t1d_sa/processors"
    cache_dir = "/home/yongdaf2/t1d_sa/cache"
    ...
    if os.path.exists(os.path.join(processor_dir, "input_processors.pkl")):
        ...
        sample_dataset = base_dataset.set_task(
            T1DDKAPredictionMIMIC4(padding=20),
            num_workers=16,
            cache_dir=cache_dir,
    ...
    trainer = Trainer(
        ...
        output_path="/home/yongdaf2/t1d_sa/output"
    )
