"""
Example of using Transformer for mortality prediction on MIMIC-IV.
...
if __name__ == "__main__":
    ...
    # STEP 2: Apply Transformer DKA prediction task with padding
    #
    ...
    processor_dir = "/home/yongdaf2/dka_tf/processors"
    cache_dir = "/home/yongdaf2/dka_tf/cache"
    ...
    if os.path.exists(os.path.join(processor_dir, "input_processors.pkl")):
        ...
        sample_dataset = base_dataset.set_task(
            DKAPredictionMIMIC4(padding=20),
            num_workers=16,
            cache_dir=cache_dir,
    ...
    trainer = Trainer(
        ...
        output_path="/home/yongdaf2/dka_tf/output"
    )
