...
if data == "mimic3":
    ...
    mimic3dataset.stat()
    mimic3dataset.set_task(readmission_prediction_mimic3_fn)
    mimic3dataset.stat()
    ...
    eicudataset.stat()
    eicudataset.set_task(task_fn=readmission_prediction_eicu_fn)
    eicudataset.stat()
    dataset = eicudataset
    ...
    mimic4dataset.stat()
    mimic4dataset.set_task(task_fn=readmission_prediction_mimic4_fn)
    mimic4dataset.stat()
