"""
Example of using GAMENet for drug recommendation on MIMIC-IV with Optuna tuning.
...
4. Tuning a GAMENet model for multi-label classification using Optuna
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="GAMENet for Drug Recommendation on MIMIC-IV with Optuna"
    )
    parser.add_argument(
        "--device",
        type=str,
