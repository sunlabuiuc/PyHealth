"""
Example of using RETAIN for length of stay prediction on MIMIC-IV with Optuna tuning.
...
4. Tuning a RETAIN model for multi-class classification using Optuna
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="RETAIN for Length of Stay Prediction on MIMIC-IV with Optuna"
    )
    parser.add_argument(
        "--device",
        type=str,
