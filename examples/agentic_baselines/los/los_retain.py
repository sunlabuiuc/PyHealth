"""
Example of using RETAIN for length of stay prediction on MIMIC-IV.
...
4. Training a RETAIN model for multi-class classification
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="RETAIN for Length of Stay Prediction on MIMIC-IV"
    )
    parser.add_argument(
        "--device",
        type=str,
