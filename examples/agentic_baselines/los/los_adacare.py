"""
Example of using AdaCare for length of stay prediction on MIMIC-IV.
...
4. Training an AdaCare model for multi-class classification
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="AdaCare for Length of Stay Prediction on MIMIC-IV"
    )
    parser.add_argument(
        "--device",
        type=str,
