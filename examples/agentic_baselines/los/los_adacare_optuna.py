"""
Example of using AdaCare for length of stay prediction on MIMIC-IV with Optuna tuning.
...
4. Tuning an AdaCare model for multi-class classification using Optuna
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="AdaCare for Length of Stay Prediction on MIMIC-IV with Optuna"
    )
    parser.add_argument(
        "--device",
        type=str,
