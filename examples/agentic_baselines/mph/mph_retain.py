"""
Example of using RETAIN for in-hospital mortality prediction on MIMIC-IV.
...
Model: RETAIN (REverse Time AttentIoN)
    ...
    - Allows understanding which timepoints and lab features contribute to predictions
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="RETAIN for In-Hospital Mortality Prediction on MIMIC-IV (Lab-based)"
    )
    parser.add_argument(
        "--device",
        type=str,
