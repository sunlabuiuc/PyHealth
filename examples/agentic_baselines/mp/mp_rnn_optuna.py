"""
Example of using RNN for mortality prediction on MIMIC-IV with Optuna tuning.
...
4. Tuning an RNN model for binary classification using Optuna
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="RNN for Mortality Prediction on MIMIC-IV with Optuna"
    )
    parser.add_argument(
        "--device",
        type=str,
