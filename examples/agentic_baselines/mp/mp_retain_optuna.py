"""
Example of using RETAIN for mortality prediction on MIMIC-IV with Optuna tuning.
...
4. Tuning a RETAIN model for binary classification using Optuna
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="RETAIN for Mortality Prediction on MIMIC-IV with Optuna"
    )
    parser.add_argument(
        "--device",
        type=str,
