...
# python -u examples/interpretability/dka_transformer_mimic4_interpret.py --methods ig --device cuda:2 2>&1 | tee -a /shared/eng/pyhealth_dka/output/dka_transformer_mimic4/ig.log
def main():
