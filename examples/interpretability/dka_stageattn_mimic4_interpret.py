...
# python -u examples/interpretability/dka_stageattn_mimic4_interpret.py --methods deeplift --device cuda:4 2>&1 | tee -a /shared/eng/pyhealth_dka/output/dka_stageattn_mimic4/deeplift.log
def main():
    ...
    print("=" * 70)
    print("Interpretability Metrics Example: StageAttn + MIMIC-IV")
    print("=" * 70)
    ...
    # Set path
    CACHE_DIR = Path("/shared/eng/pyhealth_dka/cache/dka_stageattn_mimic4")
    CKPTS_DIR = Path("/shared/eng/pyhealth_dka/ckpts/dka_stageattn_mimic4")
    OUTPUT_DIR = Path("/shared/eng/pyhealth_dka/output/dka_stageattn_mimic4")
    ...
    print("\n Loading pre-trained StageAttn model...")
