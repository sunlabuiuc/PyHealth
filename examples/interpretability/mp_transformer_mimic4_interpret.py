...
# python -u examples/interpretability/mp_transformer_mimic4_interpret.py --methods ig --device cuda:6 2>&1 | tee -a /home/yongdaf2/pyhealth_dka/output/mp_transformer_mimic4/ig.log
def main():
