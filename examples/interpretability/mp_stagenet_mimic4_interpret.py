...
# python -u examples/interpretability/mp_stagenet_mimic4_interpret.py --methods ig --device cuda:3 2>&1 | tee -a /home/yongdaf2/pyhealth_dka/output/mp_stagenet_mimic4/ig.log
def main():
