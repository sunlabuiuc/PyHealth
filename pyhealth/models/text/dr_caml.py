...
class callPredictor(nn.Module):
    ...
    def __init__(self, 
        ...
        self.lweight = torch.nn.Parameter(torch.zeros(label_size, fc_in_d, 1).float())
    ...
    def forward(self, input_data):
        ...
        for i in range(self.label_size):
            ...
            weights = weights/torch.sum(weights + 0.001, -1).reshape(n_case, 1)
...
class DRCAML(BaseControler):
    ...
    def __init__(self, 
        ...
        super(DRCAML, self).__init__(expmodel_id)
