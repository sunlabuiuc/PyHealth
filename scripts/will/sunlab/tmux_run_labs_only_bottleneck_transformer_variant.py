...
use_old_cache = True
session_name = f"bottleneck_transformer_{task}_s{seed}"
...
log_dir = logs_dir
log_tag = f"bottleneck_transformer_{task}_s{seed}_{date_str}"
...
python examples/mortality_prediction/unified_embedding_e2e_mimic4.py \\
    ...
    --fusion-startidx {fusion_startidx} \\
    --dropout {dropout} \\
    --epochs {epochs} \\
